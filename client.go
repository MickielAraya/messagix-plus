...
func createCustomCharlesClientProfile() profiles.ClientProfile {
	...
	settings := map[http2.SettingID]uint32{
		http2.SettingHeaderTableSize:   4096,       // SETTINGS_HEADER_TABLE_SIZE
		http2.SettingEnablePush:        0,          // SETTINGS_ENABLE_PUSH
		http2.SettingInitialWindowSize: 2147483647, // SETTINGS_INITIAL_WINDOW_SIZE
		http2.SettingMaxFrameSize:      16384,      // SETTINGS_MAX_FRAME_SIZE
	}
	...
	var CustomCharlesCLient = profiles.NewClientProfile(
		clientHelloId,
		settings,
		settingsOrder,
		pseudoHeaderOrder,
	...
	return CustomCharlesCLient
}

func (c *Client) createHttpClient(proxy string) (tls_client.HttpClient, error) {
	CustomCharlesCLient := createCustomCharlesClientProfile()

	options := []tls_client.HttpClientOption{
		tls_client.WithTimeoutSeconds(30),
		tls_client.WithClientProfile(CustomCharlesCLient),
	}
